...
class WesternSeriesTabWidget extends StatefulWidget {
  String genere;
  WesternSeriesTabWidget({Key? key,required this.genere,}) : super(key: key);

  @override
  _WesternSeriesTabWidgetState createState() => _WesternSeriesTabWidgetState();
}

class _WesternSeriesTabWidgetState extends State<WesternSeriesTabWidget> {
