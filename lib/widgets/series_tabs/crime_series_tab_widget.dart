...
class CrimeSeriesTabWidget extends StatefulWidget {
  String genere;
  CrimeSeriesTabWidget({Key? key,required this.genere,}) : super(key: key);

  @override
  _CrimeSeriesTabWidgetState createState() => _CrimeSeriesTabWidgetState();
}

class _CrimeSeriesTabWidgetState extends State<CrimeSeriesTabWidget> {
