...
class HistoryMoviesTabWidget extends StatefulWidget {
  String genere;
  HistoryMoviesTabWidget({Key? key,required this.genere}) : super(key: key);

  @override
  _HistoryMoviesTabWidgetState createState() => _HistoryMoviesTabWidgetState();
}

class _HistoryMoviesTabWidgetState extends State<HistoryMoviesTabWidget> {
