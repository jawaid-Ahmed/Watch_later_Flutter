...
class RomanceMoviesTabWidget extends StatefulWidget {
  String genere;
  RomanceMoviesTabWidget({Key? key,required this.genere}) : super(key: key);

  @override
  _RomanceMoviesTabWidgetState createState() => _RomanceMoviesTabWidgetState();
}

class _RomanceMoviesTabWidgetState extends State<RomanceMoviesTabWidget> {
