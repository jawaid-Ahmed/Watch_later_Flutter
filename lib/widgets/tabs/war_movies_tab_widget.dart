...
class WarMoviesTabWidget extends StatefulWidget {
  String genere;
  WarMoviesTabWidget({Key? key,required this.genere}) : super(key: key);

  @override
  _WarMoviesTabWidgetState createState() => _WarMoviesTabWidgetState();
}

class _WarMoviesTabWidgetState extends State<WarMoviesTabWidget> {
