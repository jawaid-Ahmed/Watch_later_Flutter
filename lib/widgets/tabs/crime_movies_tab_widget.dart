...
class CrimeMoviesTabWidget extends StatefulWidget {
  String genere;
  CrimeMoviesTabWidget({Key? key,required this.genere}) : super(key: key);

  @override
  _CrimeMoviesTabWidgetState createState() => _CrimeMoviesTabWidgetState();
}

class _CrimeMoviesTabWidgetState extends State<CrimeMoviesTabWidget> {
