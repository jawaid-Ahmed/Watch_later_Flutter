...
class DocumentaryMoviesTabWidget extends StatefulWidget {
  String genere;
  DocumentaryMoviesTabWidget({Key? key,required this.genere}) : super(key: key);

  @override
  _DocumentaryMoviesTabWidgetState createState() => _DocumentaryMoviesTabWidgetState();
}

class _DocumentaryMoviesTabWidgetState extends State<DocumentaryMoviesTabWidget> {
