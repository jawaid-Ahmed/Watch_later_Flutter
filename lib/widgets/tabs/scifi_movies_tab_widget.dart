...
class ScifiMoviesTabWidget extends StatefulWidget {
  String genere;
  ScifiMoviesTabWidget({Key? key,required this.genere}) : super(key: key);

  @override
  _ScifiMoviesTabWidgetState createState() => _ScifiMoviesTabWidgetState();
}

class _ScifiMoviesTabWidgetState extends State<ScifiMoviesTabWidget> {
