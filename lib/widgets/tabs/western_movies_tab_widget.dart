...
class WesternMoviesTabWidget extends StatefulWidget {
  String genere;
  WesternMoviesTabWidget({Key? key,required this.genere}) : super(key: key);

  @override
  _WesternMoviesTabWidgetState createState() => _WesternMoviesTabWidgetState();
}

class _WesternMoviesTabWidgetState extends State<WesternMoviesTabWidget> {
