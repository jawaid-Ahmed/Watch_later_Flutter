...
class FamilyMoviesTabWidget extends StatefulWidget {
  String genere;
  FamilyMoviesTabWidget({Key? key,required this.genere}) : super(key: key);

  @override
  _FamilyMoviesTabWidgetState createState() => _FamilyMoviesTabWidgetState();
}

class _FamilyMoviesTabWidgetState extends State<FamilyMoviesTabWidget> {
