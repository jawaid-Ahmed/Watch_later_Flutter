...
class MysteryMoviesTabWidget extends StatefulWidget {
  String genere;
  MysteryMoviesTabWidget({Key? key,required this.genere}) : super(key: key);

  @override
  _MysteryMoviesTabWidgetState createState() => _MysteryMoviesTabWidgetState();
}

class _MysteryMoviesTabWidgetState extends State<MysteryMoviesTabWidget> {
