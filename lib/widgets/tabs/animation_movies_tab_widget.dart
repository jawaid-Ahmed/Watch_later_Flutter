...
class AnimationMoviesTabWidget extends StatefulWidget {
  String genere;
  AnimationMoviesTabWidget({Key? key,required this.genere}) : super(key: key);

  @override
  _AnimationMoviesTabWidgetState createState() => _AnimationMoviesTabWidgetState();
}

class _AnimationMoviesTabWidgetState extends State<AnimationMoviesTabWidget> {
