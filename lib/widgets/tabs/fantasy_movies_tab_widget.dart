...
class FantasyMoviesTabWidget extends StatefulWidget {
  String genere;
  FantasyMoviesTabWidget({Key? key,required this.genere}) : super(key: key);

  @override
  _FantasyMoviesTabWidgetState createState() => _FantasyMoviesTabWidgetState();
}

class _FantasyMoviesTabWidgetState extends State<FantasyMoviesTabWidget> {
