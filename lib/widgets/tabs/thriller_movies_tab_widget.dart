...
class ThrillerMoviesTabWidget extends StatefulWidget {
  String genere;
  ThrillerMoviesTabWidget({Key? key,required this.genere}) : super(key: key);

  @override
  _ThrillerMoviesTabWidgetState createState() => _ThrillerMoviesTabWidgetState();
}

class _ThrillerMoviesTabWidgetState extends State<ThrillerMoviesTabWidget> {
